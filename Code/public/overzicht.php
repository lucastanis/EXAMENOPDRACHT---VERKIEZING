...
<body>
    ...
    JOUW STEM TELT
            ...
            <ul>
                <li><a href="#">STEMPERCENTAGE REGIO'S</a></li>
                <li><a href="../public/overzicht.php">OVERZICHT VERKIEZINGEN</a></li>
                <li><a href="#">STEMMEN</a></li>
                <br>
    ...
    <main>
        <section class="party-list">
            <article class="party">
                <h2>Partij Naam 1</h2>
                <p>Korte beschrijving van de partij.</p>
                <h3>Kandidaten:</h3>
                <ul>
                    <li>Kandidaat 1</li>
                    <li>Kandidaat 2</li>
